...
var NetworkPingImpl = /** @class */ (function () {
    ...
    NetworkPingImpl.callICMP = function (hostname, timeout) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, pingman_1.default(hostname, {
                                numberOfEchos: 1,
                                timeout: timeout,
                            })];
                    case 1:
                        resp = _a.sent();
                        return [2 /*return*/, Promise.resolve(resp.avg)];
                    case 2:
                        e_1 = _a.sent();
                        return [2 /*return*/, Promise.reject("ping failed: " + e_1)];
                    case 3: return [2 /*return*/];
                }
            });
        });
    };
    NetworkPingImpl.callUDP = function (host, port, timeout) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, Promise.reject('udp is not yet supported')];
            });
        });
    };
    NetworkPingImpl.callTCP = function (host, port, timeout) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, Promise.reject('tcp is not yet supported')];
            });
        });
    };
    NetworkPingImpl.DEFAULT_TIMEOUT = 2000;
